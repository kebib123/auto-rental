      ...
      <div class="row">
         ...
         <div class="col-lg-12">
           ...
           <div class=" text-left mb-4">
            ...
            @if($taxliabilitycompany->count()>0)
            <p>{{$data->sub_title}}</p>
            <form class="contact-form   pb-4" name="contact_form" id="contact_form"  action="{{route('taxliability')}}" method="post">
               {{ csrf_field() }}
               <div class="form-group">
                  <label>Company <span class="text-secondary"> *</span></label>
                  
                  <select name="company" class="form-control">
                    @foreach($taxliabilitycompany as $row)
