...
<section class="pb-5 pt-5 ">
   <div class="container">
      ...
      <div class="row text-center mb-5 member-list">
         <!--  -->
         <div class="col-lg-4 col-md-6 offset-md-4 offset-lg-4">
      ...
      <div class="row text-center member-list">
         <!--  -->
           @foreach($associated_posts->slice(1,3) as $row)
         ...
         <!--  -->
           @foreach($associated_posts->slice(4,1) as $row)
         ...
         <!--  -->
         <!--  -->
          @foreach($associated_posts->slice(5,1) as $row)
         <div class="col-lg-4 col-md-6  mb-5">
            <a href="#" data-toggle="modal" data-target=".team-details-{{$row->id}}">
               <div class="member pt-4 pb-4 shadow-lg  rounded">
                  <div class="member-image ">
          ...
          @endforeach
            @foreach($associated_posts->slice(6,6) as $row)
         <div class="col-lg-4 col-md-6 mb-5">
            <a href="#" data-toggle="modal" data-target=".team-details-{{$row->id}}">
               <div class="member pt-4 pb-4 shadow-lg  rounded">
                  <div class="member-image">
